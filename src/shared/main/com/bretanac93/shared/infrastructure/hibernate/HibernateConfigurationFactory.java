package com.bretanac93.shared.infrastructure.hibernate;
...
public class HibernateConfigurationFactory {
    ...
    public HibernateConfigurationFactory(ResourcePatternResolver resourcePatternResolver) {
    ...
    public DataSource dataSource(String host, Integer port, String databaseName, String username, String password) throws IOException {
        ...
        Resource mysqlResource = resourcePatternResolver.getResource(String.format(
    ...
    private List<String> subdirectoriesFor(String contextName) {
        ...
        if (null == files) {
            path = "./main/com/bretanac93/" + contextName + "/";
